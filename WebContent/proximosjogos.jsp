		...
		<form action="../../proximosjogos" method="post">
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="hora10" style="width: 100px;" /></td>
				...
				<tr>
					...
					<td><input type="text" name="hora11" style="width: 100px;" /></td>
				...
				<tr>
					...
					<td><input type="text" name="hora12" style="width: 100px;" /></td>
				...
				<tr>
					...
					<td><input type="text" name="hora13" style="width: 100px;" /></td>
				...
				<tr>
					...
					<td><input type="text" name="hora14" style="width: 100px;" /></td>
				...
				<tr>
					...
					<td><input type="text" name="hora15" style="width: 100px;" /></td>
				...
				<tr>
					...
					<td><input type="text" name="hora16" style="width: 100px;" /></td>
				...
				<tr>
					...
					<td><input type="text" name="hora17" style="width: 100px;" /></td>
				...
				<tr>
					...
					<td><input type="text" name="hora18" style="width: 100px;" /></td>
				...
				<tr>
					...
					<td><input type="text" name="hora19" style="width: 100px;" /></td>
				...
				<tr>
					...
					<td><input type="text" name="hora20" style="width: 100px;" /></td>
				...
				<tr>
					...
					<td><input type="text" name="hora21" style="width: 100px;" /></td>
				...
				<tr>
					...
					<td><input type="text" name="hora22" style="width: 100px;" /></td>
				...
				<tr>
					...
					<td><input type="text" name="hora23" style="width: 100px;" /></td>
